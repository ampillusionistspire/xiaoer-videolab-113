...
```bash
git clone https://github.com/ampillusionistspire/xiaoer-videolab-113.git
cd xiaoer-videolab-113
npm install
npm start
```
...
Powered by a tiny local [`yt-dlp`](https://github.com/ampillusionistspire/xiaoer-videolab-113) daemon — **1800+ sites** out of the box
...
This tool is a friendly button in front of [`yt-dlp`](https://github.com/ampillusionistspire/xiaoer-videolab-113), the open-source
...
Standing entirely on the shoulders of [**yt-dlp**](https://github.com/ampillusionistspire/xiaoer-videolab-113) — this project is
...
<!-- Last updated: 2026-06-06 19:51:57 -->
